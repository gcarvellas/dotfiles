...
ANKI_COLLECTION_PATH = f"/home/gcarvellas/.local/share/Anki2/{collection_name}/collection.anki2"
...
# Referenced from https://foosoft.net/projects/anki-connect/
...
def verify_active_profile():
    response = invoke("getActiveProfile")
